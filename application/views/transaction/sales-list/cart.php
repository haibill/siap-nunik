            ...
            <div class="tile-body">
                <form action="<?= $url; ?>" method="POST" class="form-horizontal">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" name="no_pengeluaran" value="<?= $result['no_pengeluaran'] ?>" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="number" name="qty" value="<?= set_value('qty') ?>" placeholder="Please type the qty..">
                            <?= form_error('qty'); ?>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" name="" value="<?= "Rp " . number_format($price['nominal'], 2, ',', '.') ?>" readonly>
                            <input class="form-control" type="hidden" name="harga" value="<?= $price['nominal'] ?>" readonly>
                        </div>
                    </div>
