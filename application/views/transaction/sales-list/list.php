    ...
    <div class="col-md-12">
        <div class="tile">
                            ...
                            <tr>
                                ...
                                <?php if ($result['keterangan'] == 'Unprocessed') : ?>
                                    <td style="text-align: center;">
                                        <a href="<?= site_url('jualBarang/delete/' . $item['no_pengeluaran'] . '/' . $item['kode_barang']) ?>" class="btn btn-sm btn-danger"><i class="icon fa fa-close fa-lg"></i> Remove</a>
                                    </td>
                                <?php endif; ?>
                            </tr>
            ...
            <div class="tile-footer text-center">
                <?php if ($list != NULL) : ?>
                    <?php if ($result['keterangan'] == 'Unprocessed') : ?>
                        <!-- <a href="<?= site_url('JualBarang/complete/' . $item['no_pengeluaran'] . '/' . $total) ?>" class="btn btn-info">COMPLETE !</a> -->
                        <a href="#complete" class="btn btn-info" data-toggle="modal">COMPLETE !</a>
                    <?php endif; ?>
                <?php else : ?>
...
<?php $this->load->view('transaction/sales-list/modal-complete') ?>