...
<div class="row">
    <div class="col-md-12">
        <div class="tile">
            <h6 class="tile-title line-head text-success"><?= $this->uri->segment(3) . " Detail" ?></h6>
            <div class="tile-body">
                <form class="form-horizontal">
                    <div class="form-group row">
                        <label class="control-label col-md-2 font-weight-bold">Transaction ID</label>
                        <div class="col-md-8">
                            <input class="form-control" type="text" value="<?= $result['no_penerimaan'] ?>" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label class="control-label col-md-2 font-weight-bold">Created Date</label>
                        <div class="col-md-8">
                            <input class="form-control" type="text" value="<?= $result['tgl_penerimaan'] ?>" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="control-label col-md-2 font-weight-bold">Information</label>
                        <div class="col-md-8">
