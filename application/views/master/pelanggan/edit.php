                ...
                <div class="col-lg-12">
                    <form action="<?= $url; ?>" method="POST">
                        <div class="form-group">
                            <label class="font-weight-bold"><b class="text-danger">*</b> Customer Name</label>
                            <input class="form-control" type="text" name="nama_pelanggan" value="<?= $result['nama'] ?>" placeholder="Masukkan nama pelanggan">
                        ...
                        <input class="form-control" type="hidden" name="kode_pelanggan" value="<?= $result['kode_pelanggan'] ?>" readonly>
